...
const services = [
  ...
  [
    "⚙",
    "Test Automation",
    "Scalable automation strategies and frameworks that accelerate releases while improving quality and confidence.",
  ],
  [
    "◉",
    "Performance Testing",
    "Load, stress, endurance and scalability testing to identify performance risks before they impact users.",
  ],
  [
    "▣",
    ...
    <main>
      ...
      <section className="hero">
        <div className="wrap hero-grid">
          <div>
            ...
            <p>
              We help organisations deliver reliable, scalable and high-performing
              web, mobile and enterprise applications through expert functional
            ...
            <div className="stats">
              ...
              <div className="stat">
                ...
                Functional & non-functional expertise
              </div>
            </div>
          </div>
      ...
      <section id="services" className="section muted">
        <div className="wrap">
          ...
          <h2>Quality engineering built around your business.</h2>

          <p className="lead">
            From validating a critical release to improving an entire QA
            capability, Quality-Benchmark Solutions brings independent expertise
            and a practical delivery mindset.
          </p>
      ...
      <section id="why" className="section">
        <div className="wrap split">
          <div>
            ...
            <h2>Experience that goes beyond testing.</h2>
            ...
            <ul className="list">
              <li>15+ years of enterprise QA experience</li>
              <li>Functional and non-functional testing expertise</li>
              <li>Web, mobile and enterprise application coverage</li>
              <li>Independent and objective quality assessment</li>
              <li>Modern automation and performance engineering approach</li>
            </ul>
          </div>
          ...
          <div className="panel">
            ...
            <p>
              ...
              risks and release objectives. We then design the right testing
              approach rather than forcing a one-size-fits-all service.
            </p>

            <p>
              <strong>Outcome:</strong> clearer quality risk, stronger release
              confidence and better customer experiences.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section muted">
        <div className="wrap">
          ...
          <h2>A flexible path to better quality.</h2>

          <div className="process">
            <div className="card step">
              <div className="num">01 / DISCOVER</div>
              <h3>Understand</h3>
              <p>
                Business goals, architecture, risks and current quality
                challenges.
              </p>
            </div>

            <div className="card step">
              <div className="num">02 / ASSESS</div>
              <h3>Analyse</h3>
              <p>
                Testing maturity, coverage, bottlenecks and quality risks.
              </p>
            </div>

            <div className="card step">
              <div className="num">03 / ENGINEER</div>
              <h3>Design</h3>
              <p>
                A focused functional and non-functional testing strategy.
              </p>
            </div>

            <div className="card step">
              <div className="num">04 / ASSURE</div>
              <h3>Deliver</h3>
              <p>
                Actionable insights and measurable improvement in release
                confidence.
              </p>
            </div>
          </div>
      ...
      <section id="about" className="section">
        <div className="wrap split">
          <div className="panel">
            ...
            <h2>Built on experience. Focused on quality.</h2>
          </div>
          ...
          <div>
            ...
            <p>
              <strong>Founded and led by Shashank Shekhar</strong>, an
            ...
            <p>
              His experience includes leading testing organisations,
              client-facing delivery, performance engineering, workload
              modelling and release quality assurance across consulting and
              enterprise engagements.
            </p>

            <p>
              <strong>
                Our mission is simple: help organisations release software with
                confidence.
              </strong>
            </p>
          </div>
      ...
      <section id="contact" className="contact">
        <div className="wrap split">
          <div>
            ...
            <p>
              <strong>Call / WhatsApp:</strong> +91 70199 52138
              <br />
          ...
          <div className="card">
            ...
            <form
              onSubmit={(e) => {
                e.preventDefault();
                alert(
                  "Thank you. Your contact form is ready for email integration before launch."
                );
              }}
            >
